class Game {
  ...
  play() {
    ...
    //chamando a função handleResetButton aqui -- aluno
  ...
  //exibição de classificação, pontuação, e nome 
  showLeaderboard() {
    var leader1, leader2;
    ...
    //if--caso o player 1 fique acima
    if (
  ...
  handlePlayerControls() {
    ...
    //direção pro carrinho--aqui--aluno
